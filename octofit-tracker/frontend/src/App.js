    ...
    <Router>
      <div className="container">
        ...
        <Routes>
          ...
          <Route path="/" element={<div className="card"><div className="card-body"><h2 className="h3">Welcome to Octofit Tracker!</h2><p className="lead">Track your fitness, join teams, and compete on the leaderboard.</p></div></div>} />
        </Routes>
      </div>
    </Router>
  );
